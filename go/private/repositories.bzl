...
def go_rules_dependencies(force = False):
    ...
    wrapper(
        ...
        # v0.13.0, latest as of 2023-09-18
        urls = [
            "https://mirror.bazel.build/github.com/golang/tools/archive/refs/tags/v0.13.0.zip",
            "https://github.com/golang/tools/archive/refs/tags/v0.13.0.zip",
        ],
        sha256 = "a44668d121ccf39fb2112ea38ab76e043f89f949c280c738f3d2a4d40a473942",
        strip_prefix = "tools-0.13.0",
        patches = [
