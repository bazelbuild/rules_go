...
#
# Generated this list by running
#
...
def staticcheck_analyzers(analyzers, prefix_path = "@io_bazel_rules_go//go/analyzer/staticcheck"):
    """A helper function that make it easier/cleaner to declare these analyers in nogo target
    Instead of:
        nogo(
            name = "nogo",
            deps = TOOLS_NOGO + [
                "@io_bazel_rules_go//go/analyzer/staticcheck:ST1000",
                "@io_bazel_rules_go//go/analyzer/staticcheck:ST1001",
            ],
